...
<head id="Head1" runat="server">
    ...
    <script src="../CookieTest/Cookie.js" type="text/javascript"></script>
...
<body>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ho_c_c_b">
		...
		<div id="dbl_b"><input name="button" type="button" value="对&nbsp;比" class="ho_sb" />&nbsp;<input name="button" type="button" value="清&nbsp;空" class="ho_sb" /></div>
	</div>
    </div>
